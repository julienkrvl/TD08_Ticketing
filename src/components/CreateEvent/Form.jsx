	...
	render() {
		...
		return (
			<form>
				...
				<div className="form-group">
					<p>Image de couverture de l'événement:</p>
					...
					<small className="form-text text-muted">Format de l'image : jpg, png. Taille max : 1mb.</small>
				</div>
				<div className="form-group">
					<label htmlFor="description">Date et heure de l'événement:</label>
					<Datetime closeOnSelect={true} onChange={this.handleDate} inputProps={{className : "form-control " + warning.time}} />
				</div>
				<div className="form-group">
					<p>Option de paiement:</p>
				...
				<div className="form-group">
					<p>Option des places disponibles:</p>
					<div className="custom-control custom-checkbox">
						<input type="checkbox" className="custom-control-input" id="limited" value="true" onChange={this.handleLimited} />
						<label className="custom-control-label" htmlFor="limited">Place limitée</label>
					</div>
					<div className="row mt-3">
						<div className="col-lg-3">
							<label htmlFor="seats">Nombre de place max :</label>
				...
				{alert}
				<button type="submit" className="btn btn-outline-dark" onClick={this.handleForm}>Créer un événement</button>
			</form>
		);
	}
}
