				...
				body =
					<div className="row">
						<div className="col-6">
							...
							{description}
							<div className="mt-5">
								<button className="btn btn-dark" onClick={this.buyTicket} disabled={disabled}><i className="fas fa-ticket-alt"></i> Acheter un ticket</button>
						...
						<div className="col-6">
							<div className="card">
								...
								<ul className="list-group list-group-flush">
									<li className="list-group-item">Prix: {symbol}{price}</li>
									<li className="list-group-item">{date.toLocaleDateString()} at {date.toLocaleTimeString()}</li>
									<li className="list-group-item">Places: {event_data[6]}/{max_seats}</li>
								</ul>
							</div>
						</div>
					</div>
